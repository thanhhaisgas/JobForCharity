...
public class HistoryWorksFragment extends Fragment {
    public static HistoryWorksFragment newInstance(){
        HistoryWorksFragment fragment = new HistoryWorksFragment();
