...
public class FeatureWorksFragment extends Fragment {
    public static FeatureWorksFragment newInstance(){
        FeatureWorksFragment fragment = new FeatureWorksFragment();
