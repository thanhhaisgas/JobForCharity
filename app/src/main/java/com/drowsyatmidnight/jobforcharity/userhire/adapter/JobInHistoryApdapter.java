...
public class JobInHistoryApdapter extends RecyclerView.Adapter<JobInProgressHolder> {
    private Context context;
    private View rootView;
    private LayoutInflater layoutInflater;
    private List<Job_Model> job_models;

    public JobInHistoryApdapter(Context context, List<Job_Model> job_models) {
